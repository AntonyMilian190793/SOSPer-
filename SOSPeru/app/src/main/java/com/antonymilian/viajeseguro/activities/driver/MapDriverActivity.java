...
public class MapDriverActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeofireProvieder = new GeofireProvider("drivers_activos");
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mListener != null) {
            mGeofireProvieder.isDriverWorking(mAuthProvider.getId()).removeEventListener(mListener);
        }
    }

    private void isDriverWorking() {
        mListener = mGeofireProvieder.isDriverWorking(mAuthProvider.getId()).addValueEventListener(new ValueEventListener() {
            @Override
