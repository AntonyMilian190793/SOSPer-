...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                    ...
                    mMarker = mMap.addMarker(new MarkerOptions().position(
                            new LatLng(location.getLatitude(), location.getLongitude())
                                    ...
                                    .title("Tu posicion")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.icons_ubicaci_n_del_usuario))
                    );
                    /*
                     */
    ...
    private void requestDriver() {
        if(mOriginLatLng != null && mDestinationLatLng != null){
            ...
            Toast.makeText(this, "Debe seleccionar el lugar de recogida y el de destino", Toast.LENGTH_SHORT).show();
        }
    }

    //para limitar la busqueda
    ...
    private void instanceAutocompleteOrigin(){
        ...
        mAutocomplete.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.d("LUGAR", "name: " + mOrigin);
                Log.d("LUGAR", "Lat: " + mOriginLatLng.latitude);
                Log.d("LUGAR", "Lng: " + mOriginLatLng.longitude);
            }
    ...
    private void instanceAutocompleteDestination(){
        ...
        mAutocompleteDestination.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.d("DESTINO", "name: " + mDestination);
                Log.d("DESTINO", "Lat: " + mDestinationLatLng.latitude);
                Log.d("DESTINO", "Lng: " + mDestinationLatLng.longitude);
            }
    ...
    private void getActivesDrivers() {
        mGeofireProvider.getActivesDrivers(mCurrentLatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                //se añadira marcadores de los conductores que se conecten en la aplicacion
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.icons_police)));
                marker.setTag(key);
