package com.antonymilian.viajeseguro.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.antonymilian.viajeseguro";
    private static final String CHANNEL_NAME = "viajeSeguro";
